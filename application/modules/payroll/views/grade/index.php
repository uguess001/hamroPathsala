                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_grade_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="bi bi-view-list"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'payroll', 'grade')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('payroll/grade/add'); ?>" aria-expanded="false"><i class="bi bi-patch-plus-fill"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_grade" role="tab" data-toggle="tab" aria-expanded="false"><i class="bi bi-patch-plus-fill"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12" onchange="get_grade_by_school(this.value);">
                                    ...
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('payroll/grade/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="grade_unit"><?php echo $this->lang->line('grade_unit'); ?> <span class="required">*</span></label>
                                            <input class="form-control col-md-7 col-xs-12" name="grade_unit" id="add_grade_unit" value="<?php echo isset($post['grade_unit']) ?  $post['grade_unit'] : ''; ?>" placeholder="<?php echo $this->lang->line('grade_unit'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('grade_unit'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="grade_amt"><?php echo $this->lang->line('grade_amt'); ?> <span class="required">*</span></label>
                                            <input class="form-control col-md-7 col-xs-12" name="grade_amt" id="add_grade_amt" value="<?php echo isset($post['grade_amt']) ?  $post['grade_amt'] : ''; ?>" placeholder="<?php echo $this->lang->line('grade_amt'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('grade_amt'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="grade_unit"><?php echo $this->lang->line('grade_unit'); ?> <span class="required">*</span></label>
                                                <input class="form-control col-md-7 col-xs-12" name="grade_unit" id="edit_grade_unit" value="<?php echo isset($grade->grade_unit) ?  $grade->grade_unit : ''; ?>" placeholder="<?php echo $this->lang->line('grade_unit'); ?>" required="required" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('grade_unit'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="grade_amt"><?php echo $this->lang->line('grade_amt'); ?> <span class="required">*</span></label>
                                                <input class="form-control col-md-7 col-xs-12" name="grade_amt" id="edit_grade_amt" value="<?php echo isset($grade->grade_amt) ?  $grade->grade_amt : ''; ?>" placeholder="<?php echo $this->lang->line('grade_amt'); ?>" required="required" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('grade_amt'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
...
<script type="text/javascript">
    ...
    $('.fn_add_claculate').on('keyup', function() {
        ...
        var grade_unit = $('#add_grade_unit').val() ? parseFloat($('#add_grade_unit').val()) : 0;
        var grade_amt = $('#add_grade_amt').val() ? parseFloat($('#add_grade_amt').val()) : 0;
        var grade_total = grade_amt * grade_unit;
        var total_salary = basic_salary + grade_total;
        ...
        $('#add_gross_salary').val(total_salary + total_allowance);
        $('#add_net_salary').val((total_salary + total_allowance) - total_deduction);
    ...
    $('.fn_edit_claculate').on('keyup', function() {
        ...
        var grade_unit = $('#edit_grade_unit').val() ? parseFloat($('#edit_grade_unit').val()) : 0;
        var grade_amt = $('#edit_grade_amt').val() ? parseFloat($('#edit_grade_amt').val()) : 0;
        var grade_total = grade_amt * grade_unit;
        var total_salary = basic_salary + grade_total;
        $('#edit_gross_salary').val(total_salary + total_allowance);
        $('#edit_net_salary').val((total_salary + total_allowance) - total_deduction);
