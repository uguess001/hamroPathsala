...
class Grade extends MY_Controller {
    ...
    private function _prepare_grade_validation() {
        ...
        $this->form_validation->set_rules('grade_amt', $this->lang->line('grade_amt'), 'trim|required');
        $this->form_validation->set_rules('grade_unit', $this->lang->line('grade_unit'), 'trim|required');   
