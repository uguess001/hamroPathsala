     ...
     <div class="tab-content">
                ...
                <tbody>
                   <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->lang->line($school->plan_name); ?></td>        
                        <th><?php echo $this->lang->line('status'); ?></th>
                        <td><?php echo $this->lang->line($school->subscription_status); ?></td>
                    </tr>
                    <tr>
        ...
        <div  class="tab-pane fade in" id="tab_setting_info" > 
            ...
            <tbody>                               
                ...
                <tr>  
                    <th><?php echo $this->lang->line('google_map'); ?></th>
                    <td colspan="3" style="height: 200px;"><?php echo $school->google_map; ?></td>  
                </tr>               
            </tbody>
        </table>
        </div>
