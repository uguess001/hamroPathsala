        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_page_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="bi bi-view-list"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'frontend', 'frontend')){ ?>
                            
                          <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('frontend/add'); ?>"  role="tab"  aria-expanded="false"><i class="bi bi-patch-plus-fill"></i> <?php echo $this->lang->line('create_page'); ?></a> </li>                          
                          <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_page"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="bi bi-patch-plus-fill"></i> <?php echo $this->lang->line('create_page'); ?></a> </li>                          
                          <?php } ?>   
