            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>     
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_about_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="bi bi-view-list"></i>  <?php echo $this->lang->line('list'); ?></a> </li>
                    <?php } ?>  
                    <?php if(isset($edit)){ ?>
