    ...
    * ********************************************************** */
    public function sattendance() {
        ...
        if ($_POST) {
            ...
            $yearinfo = $session->session_year;
            $strArray = explode(' ',$yearinfo);
            $session_end_year = $strArray[4];
            $session_start_year = $strArray[1];

            $month_arr = [1,2,3];
            if(in_array($this->data['month_number'],$month_arr)){
                // select last year
                $selected_year = $session_end_year;
            }else{
                // select first year
                $selected_year = $session_start_year;
            }
            ...
            $this->data['days'] =  @date('t', mktime(0, 0, 0, $this->data['month_number'], 1, $selected_year));
