            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_module_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="bi bi-view-list"></i> Module List</a> </li>
                        
                        <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_module"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="bi bi-patch-plus-fill"></i> Add Module</a> </li>                          
