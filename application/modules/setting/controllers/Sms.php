...
class Sms extends MY_Controller {
    ...
    function __construct() {
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){                 
            if(!check_saas_status($this->session->userdata('school_id'), 'is_enable_sms_gateway')){                        
              redirect('dashboard/index');
            }
        }
    ...
    * ********************************************************** */
    ...
    /*****************Function bulk360**********************************
    * @type            : Function
    * @function name   : bulk360
    * @description     : Load "bulk360 Setting Tab" user interface                 
    *                     and process to save bulk360 sms setting inormation into database  
    * @param           : null
    * @return          : null 
    * ********************************************************** */
    public function bulk360() {

        check_permission(EDIT);

        if ($_POST) {
            $this->_prepare_bulk360_validation();
    ...
    /*****************Function _prepare_bulk360_validation**********************************
    * @type            : Function
    * @function name   : _prepare_bulk360_validation
    * @description     : Process "bulk360 SMS Gateway" user input data validation                 
    *                       
    * @param           : null
    * @return          : null 
    * ********************************************************** */
    private function _prepare_bulk360_validation() {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<div class="error-message" style="text-align: center;color: red;">', '</div>');
        $this->form_validation->set_rules('school_id', $this->lang->line('school_name'), 'trim|required');
    ...
    * @type            : Function
    * @function name   : smsto
    * @description     : Load "smsto Setting Tab" user interface                 
    *                     and process to save smsto sms setting inormation into database  
    * @param           : null
    * @return          : null 
    * ********************************************************** */
    public function smsto() {
        ...
        if ($_POST) {
            $this->_prepare_smsto_validation();
    ...
    /*****************Function _prepare_smsto_validation**********************************
    * @type            : Function
    * @function name   : _prepare_smsto_validation
    * @description     : Process "smsto SMS Gateway" user input data validation                 
    *                       
    * @param           : null
    * @return          : null 
    * ********************************************************** */
    private function _prepare_smsto_validation() {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<div class="error-message" style="text-align: center;color: red;">', '</div>');
        $this->form_validation->set_rules('school_id', $this->lang->line('school_name'), 'trim|required');
