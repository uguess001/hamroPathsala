<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            <th width='30%'><?php echo $this->lang->line('border_color'); ?></th>
            <td width='20%'><span style="padding: 4px 10px; background-color:<?php echo $setting->border_color; ?>"></span></td>        
            <th width='30%'><?php echo $this->lang->line('top_background'); ?> </th>
            <td width='20%'><span style="padding: 4px 10px; background-color:<?php echo $setting->top_bg; ?>"></span></td>
        </tr>
