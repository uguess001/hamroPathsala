<style type="text/css">
    ...
    .single-facilities::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/round-light-sea-green.png);
    }
    ...
    .single-news::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-1-light-sea-green.png);
    }
    ...
    .single-notice::after,
    .single-news::after {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-2-light-sea-green.png);
    }
