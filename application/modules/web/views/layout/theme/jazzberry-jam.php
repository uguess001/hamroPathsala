<style type="text/css">
    ...
    .single-teacher .social li a,
    .gallery-menu .button {
        border: 1px solid #9F134E;
    }
    .header-bottom {
        border-bottom: 1px solid #9F134E;
    }
    ...
    .section-title .title {
        border-bottom: 3px solid #9F134E;
    }
    
     footer {
     border-top: 3px solid #9F134E;
    }


    .single-achivement {
        border: 4px solid #9F134E;
    }

    .single-achivement .icon {
        border-bottom: 2px solid #9F134E;
        color:  #9F134E;    
    }


    .single-facilities::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/round-jazzberry-jam.png);
    }
    ...
    .single-news::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-1-jazzberry-jam.png);
    }
    ...
    .single-notice::after,
    .single-news::after {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-2-jazzberry-jam.png);
    }
