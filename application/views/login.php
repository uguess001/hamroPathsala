    ...
    <div class="login_wrapper">
        <section class="m-wrapper">
            ...
            <div class="form login_form">
                <section>
                    <h1 class="text-center bold"><?php echo $this->lang->line('login'); ?> sc</h1>
                </section>
                <section class="login_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <input class="btn bg-primary text-white btn-block" type="submit" name="submit" value="<?php echo $this->lang->line('login'); ?>" />
                        <a class="reset_pass btn bg-link" href="<?php echo site_url('auth/forgot') ?>"><?php echo $this->lang->line('lost_your_password'); ?></a>
                    </div>
