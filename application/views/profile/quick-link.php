...
<a href="<?php echo site_url('profile/index'); ?>"><?php echo $this->lang->line('my_profile'); ?></a>
...
| <a href="<?php echo site_url('guardian/feedback/index'); ?>"><?php echo $this->lang->line('feedback'); ?></a>
<?php } ?>
