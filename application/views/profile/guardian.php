            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li  class="<?php if(isset($student)){ echo 'active'; }?>"><a href="#tab_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="bi bi-view-list"></i> <?php echo $this->lang->line('student_list'); ?></a> </li>                          
                    </ul>
                    <br/>
