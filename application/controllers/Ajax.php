...
class Ajax extends My_Controller
{
     ...
     * @description     : this function used to populate room list by hostel for user interface
     * @param           : null 
     ...
     * @description     : this function used to populate template by role for user interface
     * @param           : null 
     * @return          : $str string value with room list 
     * ********************************************************** */
